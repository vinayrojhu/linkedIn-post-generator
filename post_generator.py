...
def get_prompt(language,length,tag):
    length_str = get_string_length(length)
    ...
    prompt = f'''
        ...
        The script for generated post should always be English. 
    '''
...
if __name__ == "__main__" :
    post = get_prompt("English","Short" , "Influencer")
    print(post)